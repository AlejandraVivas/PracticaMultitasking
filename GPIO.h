...
/** Constant that represent all values in high*/
#define GPIO_HIGH_VALUE 0xFFFFFFFF
...
/*!
 	 ...
 	 uses the definitions GPIO_PS, GPIO_PE, GPIO_MUX1 etc. For example, in order to configure the pullup resistor and the pin as GPIO it is need to
